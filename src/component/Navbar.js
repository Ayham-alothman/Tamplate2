...
return(<>
  ...
  <div className=' h-12 bg-white relative top-4 mx-2 mb-2 rounded-full flex justify-between items-center px-2 md:max-w-1000 md:mx-auto '>
    ...
    <div className='flex space-x-3 '>
        <ul className=' hidden md:block  py-1 ' ><li className=' space-x-3 font-extralight'><a className=' py-1 px-1 rounded-2xl hover:bg-gray-200 '>How it works</a><a className=' py-1 px-1 rounded-2xl hover:bg-gray-200 '>Pricing</a></li></ul>
